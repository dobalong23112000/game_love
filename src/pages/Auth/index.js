            ...
            ${!isLogin ? 'active-form' : 'nonactive-form'}`}
                ...
                >
                    <FormGroup className={cx('form_group')}>
                        <div style={{ position: "absolute", top: '15px', left: "18px", color: 'rgba(87, 71, 188, 1)', fontWeight: 600, zIndex: 1 }}>
                ...
                <div className={`${cx('footer-register')} ${isLogin ? 'nonactive-footer' : 'active-footer'}`} onClick={() => {
                    ...
                    <div className={`${cx('register-text')}`} onClick={() => {
                        setIsLogin(false);
                        reset();
                        setErrors()

                    }}>ĐĂNG KÝ</div>
                    {!isLogin && (<Form className={`d-flex justify-content-center align-items-center flex-column ${!!isLogin ? 'active-form' : 'nonactive-form'}`} style={{ position: "absolute", top: "10vh" }} name='register_form'>
                        <FormGroup className={cx('form_group')}>
                            <div style={{ position: "absolute", top: '15px', left: "18px", fontWeight: 600, zIndex: 1 }}>
                                <AiOutlineMail size={12} color='white' />
                            </div>
                            <Input
                                id="exampleEmail"
                                placeholder="Email"
                                ...
                                className={`${errors?.email_register && `input-error`} register-input`}
                            />
                            <div className='text-error mt-1 ps-4'>{errors?.email_register?.message}</div>
                        </FormGroup>
                        <FormGroup className={cx('form_group')}>
                            <div style={{ position: "absolute", top: '15px', left: "18px", fontWeight: 600, zIndex: 1 }}>
                                <AiFillPhone size={12} color='white' />
                            </div>
                            <Input
                                id="examplePhone"
                                ...
                                className={`${errors?.phone_register && `input-error`} register-input`}
                            />
                            <div className='text-error mt-1 ps-4'>{errors?.phone_register?.message}</div>
                        </FormGroup>
                        <FormGroup className={cx('form_group')}>
                            <div style={{ position: "absolute", top: '15px', left: "18px", fontWeight: 600, zIndex: 1 }}>
                                <AiOutlineUser size={12} color='white' />
                            </div>
                            <Input
                                id="exampleUsername"
                        ...
                        <FormGroup className={cx('form_group')}>
                            <div style={{ position: "absolute", top: '15px', left: "18px", fontWeight: 600, zIndex: 1 }}>
                                <AiFillLock size={12} color='white' />
                            </div>
                            <Input
                                id="examplePassword"
                                placeholder="Mật khẩu"
                                ...
                                className={`${errors?.password_register && `input-error`} register-input`}
                            />
                        ...
                        <FormGroup className={cx('form_group')}>
                            ...
                            <Input
                                ...
                                className={`${errors?.confirm_password_register && `input-error`} register-input`}
                            />
